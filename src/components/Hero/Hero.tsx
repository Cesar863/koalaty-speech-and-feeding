...
function Hero() {
    ...
    const subtitle = 'Lorem ipsum odor amet, consectetuer adipiscing elit. Curabitur eget nulla tortor hac consequat sit pulvinar.'
    ...
    return (
        ...
        >
            <Grid container justifyContent="space-around" alignItems="center" spacing={5} sx={{ p: 5 }}>
